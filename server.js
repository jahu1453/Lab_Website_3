...
var query1 = "SELECT game_date, visitor_name, home_score, visitor_score FROM football_games WHERE game_date > '20180915';";
...
app.get('/player_info', function(req, res)
{
  ...
  //Set the variables to be passed to ejs page.
  .then(results =>
		res.render(
			'pages/player_info',
			{
